...
<html>
    <head>
        ...
        <title><g:message code="role.create.label" /></title>
    </head>
    <body>
        ...
        <div id="create-role" class="content scaffold-create" role="main">
            <h1><g:message code="role.create.label" /></h1>
            ...
            <g:form action="save">
                ...
                <fieldset class="buttons">
                    <g:submitButton name="create" class="save" value="${message(code: 'role.button.create.label', default: 'Create')}" />
                </fieldset>
            </g:form>
        </div>
    </body>
