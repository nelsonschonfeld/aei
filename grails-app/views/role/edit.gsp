...
<html>
    <head>
        ...
        <title><g:message code="role.edit.label" args="[entityName]" /></title>
    </head>
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                ...
                <li><g:link class="create" action="create"><g:message code="role.create.label" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <div id="edit-role" class="content scaffold-edit" role="main">
            <h1><g:message code="role.edit.label" /></h1>
            ...
            <g:form resource="${this.role}" method="PUT">
                ...
                <fieldset class="buttons">
                    <input class="save" type="submit" value="${message(code: 'role.button.update.label', default: 'Update')}" />
                </fieldset>
            </g:form>
        </div>
    </body>
