...
<html>
    ...
    <body>
        ...
        <div id="show-inscription" class="content scaffold-show" role="main">
            ...
            <f:display bean="inscription" />
            <g:form resource="${this.inscription}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.inscription}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
