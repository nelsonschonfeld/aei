    ...
    <body>
        ...
        <div id="edit-course" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.course}" method="PUT">
                ...
                <fieldset class="form">
                    %{--Inicio - Id del domain y no se puede editar--}%
                    <f:field bean="course" property="name" required="false">
                        <g:textField name="${property}" value="${value}" readonly="readonly"/>
                    </f:field>
                    <f:field bean="course" property="type" required="false">
                        <g:textField name="${property}" value="${value}" readonly="readonly"/>
                    </f:field>
                    <f:field bean="course" property="year" required="false">
                        <g:textField name="${property}" value="${value}" readonly="readonly"/>
                    </f:field>
                    %{--Fin - Id del domain y no se puede editar--}%
                    <f:all bean="course" except="name,type,year"/>
                </fieldset>
